...
import { LockKeyhole, UnlockKeyhole, CheckCircle2 } from "lucide-react";
        ...
        <div className="flex-row">
          ...
          {isActive && (
            <button
              ...
              className="mt-2 text-xs text-white bg-red-400 px-2 py-1 rounded hover:bg-red-100"
            >
              <CheckCircle2 className="text-red-600 w-8 h-6" />
            </button>
          )}
        </div>
